export default function AboutPage() {
  return (
    <main className="min-h-screen px-6 py-16 max-w-3xl mx-auto font-sans">
      <h1 className="text-4xl font-bold mb-6">About Me</h1>
      <p className="text-lg leading-relaxed mb-4">
        I am a passionate web developer based in Singapore. I enjoy building user-focused web apps with clean UI and efficient backend logic. What began as a simple curiosity — wondering how systems work and why certain tools behave the way they do — has grown into a deep-seated drive to build, improve, and innovate within the world of software development.
      </p>
      <p className="text-lg leading-relaxed mb-4">
